...
export class UIGame extends Component {
    ...
    start() {
        ...
        player.node.on(Events.onSettlement, this.onSettlement, this);
    ...
    onDestroy() {
        ...
        player.node.off(Events.onSettlement, this.onSettlement, this);
    ...
    onUpgrade() {
        UIManager.instance.showDialog(DialogDefine.UISkillsUpgrade);
    
    }

    onSettlement() {
        UIManager.instance.showDialog(DialogDefine.UISettlement);
    }
